...
!function (t, e) {
    ...
    t.module("smart-table", []).run(["$templateCache", function (t) {
    ...
    }]), t.module("smart-table").controller("stTableController", ["$scope", "$parse", "$filter", "$attrs", function (t, a, s, n) {
        function r(t) {
            return [].concat(t)
        }
        ...
        var c, l, o = n.stTable, u = a(o), p = u.assign, g = s("orderBy"), f = s("filter"), d = r(u(t)), h = {
            sort: {},
            search: {},
            pagination: {start: 0}
        }, m = !0, b = this;
        n.stSafeSrc && (c = a(n.stSafeSrc), t.$watch(function () {
            var e = c(t);
            return e ? e.length : 0
        }, function (t) {
            t !== d.length && i()
            ...
            return h.sort.predicate = t, h.sort.reverse = e === !0, h.pagination.start = 0, this.pipe()
        }, this.search = function (t, e) {
            var a = h.search.predicateObject || {}, s = e ? e : "$";
            return a[s] = t, t || delete a[s], h.search.predicateObject = a, h.pagination.start = 0, this.pipe()
        }, this.pipe = function () {
            var a = h.pagination, s = h.search.predicateObject ? f(d, h.search.predicateObject) : d;
            h.sort.predicate && (s = g(s, h.sort.predicate, h.sort.reverse)), a.number !== e && (a.numberOfPages = s.length > 0 ? Math.ceil(s.length / a.number) : 1, a.start = a.start >= s.length ? (a.numberOfPages - 1) * a.number : a.start, s = s.slice(a.start, a.start + a.number)), p(t, s)
        }, this.select = function (t, a) {
            var s = d, n = s.indexOf(t);
            -1 !== n && ("single" === a ? (t.isSelected = t.isSelected !== !0, l && (l.isSelected = !1), l = t.isSelected === !0 ? t : e) : s[n].isSelected = !s[n].isSelected)
        ...
        return {
            require: "^stTable", scope: {predicate: "=?stSearch"}, link: function (e, a, s, n) {
        ...
        return {
            restrict: "A", require: "^stTable", scope: {row: "=stSelectRow"}, link: function (t, e, a, s) {
        ...
        return {
            restrict: "A", require: "^stTable", link: function (s, n, r, i) {
                function c() {
                    p++, o = t.isFunction(u(s)) ? u(s) : r.stSort, p % 3 === 0 && r.stSkipNatural === e ? (p = 0, i.tableState().sort = {}, i.tableState().pagination.start = 0, i.pipe()) : i.sortBy(o, p % 2 === 0)
                }

                var l, o = r.stSort, u = a(o), p = 0, g = r.stClassAscent || "st-sort-ascent", f = r.stClassDescent || "st-sort-descent", d = [g, f];
                r.stSortDefault && (l = s.$eval(r.stSortDefault) !== e ? s.$eval(r.stSortDefault) : r.stSortDefault), n.bind("click", function () {
                    o && s.$apply(c)
                }), l && (p = "reverse" === r.stSortDefault ? 1 : 0, c()), s.$watch(function () {
                    return i.tableState().sort
                }, function (t) {
                    t.predicate !== o ? (p = 0, n.removeClass(g).removeClass(f)) : (p = t.reverse === !0 ? 2 : 1, n.removeClass(d[p % 2]).addClass(d[p - 1]))
                }, !0)
            }
        }
        ...
        return {
            restrict: "EA",
            require: "^stTable",
            scope: {stItemsByPage: "=?", stDisplayedPages: "=?"},
            ...
            link: function (t, e, a, s) {
                function n() {
                    ...
                    for (t.currentPage = Math.floor(n.start / n.number) + 1, r = Math.max(r, t.currentPage - Math.abs(Math.floor(t.stDisplayedPages / 2))), e = r + t.stDisplayedPages, e > n.numberOfPages && (e = n.numberOfPages + 1, r = Math.max(1, e - t.stDisplayedPages)), t.pages = [], t.numPages = n.numberOfPages, a = r; e > a; a++)t.pages.push(a)
                }

                t.stItemsByPage = t.stItemsByPage ? +t.stItemsByPage : 10, t.stDisplayedPages = t.stDisplayedPages ? +t.stDisplayedPages : 5, t.currentPage = 1, t.pages = [], t.$watch(function () {
